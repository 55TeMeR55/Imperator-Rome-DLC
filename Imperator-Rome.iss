...
; Всегда меняются
#define GameName "Imperator Rome"                                          ; Название игры
#define GameNameDash "Imperator-Rome"                                          ; Название игры без пробелов
#define GameNameEXE "hoi4"                                                              ; Название exe файла игры
#define GameVer "2.0"                                                                     ; Версия игры
#define GameAppIdSteam "859580"                                                             ; Ид игры в стиме
; От ситуации зависит
#define AppDescription "DLC для Imperator Rome"                                     ; Описание программы
...
[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Imperator Rome DLC
AppId={{29A4240F-42C8-408B-A88C-CAB95FAD6705}
